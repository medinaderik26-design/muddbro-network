...
async function fetchHTML() {
  try {
    const resp = await fetch("https://base44.app/api/apps/6a4020251d35ee93ec909dfa/files/mp/public/6a4020251d35ee93ec909dfa/2e6999d31_ringmine_game.html", { cache: "no-store" });
