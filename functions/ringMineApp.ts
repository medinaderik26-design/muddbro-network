...
// ── STATE ─────────────────────────────────────────────────────
var G;
try{G=JSON.parse(localStorage.getItem("rm_v4")||"null");}catch(e){G=null;}
if(!G){
...
function save(){try{localStorage.setItem("rm_v4",JSON.stringify(G));}catch(e){}}
...
// ── NAV ───────────────────────────────────────────────────────
var SCREENS=["mine","quest","journal","avatar","stats"];
function goTo(name){
...
function fight(action){
  ...
  var dmg=action==="attack"?8+Math.floor(Math.random()*10)+totalPower():action==="magic"?12+Math.floor(Math.random()*15)+G.realm*2:5+Math.floor(Math.random()*20);
